...
# using "round2.run_spearman_rank.sh" script. 
...
if [ ! -d effect_of_cluster_size_on_eQTL_discovery/percent${PERCENT}/round2 ]
then
     mkdir effect_of_cluster_size_on_eQTL_discovery/percent${PERCENT}/round2
else
     echo "Directory exists"
fi

# Main script file
RSCRIPT="/onek1k/effect_of_cluster_size_on_eQTL_discovery/round2.run_spearman_rank_test.R" 

# Do the main job
$R_PATH/Rscript --verbose ${RSCRIPT} ${PERCENT} ${SAMPLE} > rout/round2_${PERCENT}_${SAMPLE}.Rout
