...
# using "round3.run_spearman_rank.sh" script. 
...
if [ ! -d effect_of_cluster_size_on_eQTL_discovery/percent${PERCENT}/round3 ]
then
     mkdir effect_of_cluster_size_on_eQTL_discovery/percent${PERCENT}/round3
else
     echo "Directory exists"
fi

# Main script file
RSCRIPT="/onek1k/effect_of_cluster_size_on_eQTL_discovery/round3.run_spearman_rank_test.R"

# Do the main job
$R_PATH/Rscript --verbose ${RSCRIPT} ${PERCENT} ${SAMPLE} > rout/round3_${PERCENT}_${SAMPLE}.Rout
