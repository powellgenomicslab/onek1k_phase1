...
# using "round4.run_spearman_rank.sh" script. 
...
if [ ! -d effect_of_cluster_size_on_eQTL_discovery/percent${PERCENT}/round4 ]
then
     mkdir effect_of_cluster_size_on_eQTL_discovery/percent${PERCENT}/round4
else
     echo "Directory exists"
fi

# Main script file
RSCRIPT="/onek1k/effect_of_cluster_size_on_eQTL_discovery/round4.run_spearman_rank_test.R" 

# Do the main job
$R_PATH/Rscript --verbose ${RSCRIPT} ${PERCENT} ${SAMPLE} > rout/round4_${PERCENT}_${SAMPLE}.Rout
