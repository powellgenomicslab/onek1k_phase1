...
# for 14 cell types using "round2.run_spearman_rank_test.sh" script
##############################################################################
...
# Input filenames
r1_residual_filename <- sprintf("round1/%s_chr%s_log_residuals.tsv",cellLabel,chrNumber)
r1_significant_SNPs <- sprintf("round1/%s_chr%s_significant_correlation_results.tsv",cellLabel,chrNumber)
...
fwrite(eSNP1,sprintf("round1/%s_chr%s_lead_eSNP.tsv",cellLabel,chrNumber),sep="\t",quote=F)
...
fwrite(adjusted_residual_df,sprintf("round2/%s_chr%s_eSNP1_adjusted_residuals.tsv",cellLabel,chrNumber),sep="\t",quote=F)
...
fwrite(adjusted_spearman_df,sprintf("round2/%s_chr%s_round2_correlation_results.tsv",cellLabel,chrNumber),sep="\t",quote=F)
...
fwrite(adjusted_spearman_df_significant,sprintf("round2/%s_chr%s_round2_significant_correlation_results.tsv",cellLabel,chrNumber),sep="\t",quote=F)
