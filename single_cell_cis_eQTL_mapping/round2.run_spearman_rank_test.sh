...
# per chromosome for 14 cell types using "round2.run_spearman_rank_test.R" script. 
...
if [ ! -d ${CELLLABEL}/round2 ]
then
     mkdir ${CELLLABEL}/round2
else
     echo "Directory exists"
fi

# Main script file
RSCRIPT="/onek1k/Scripts/single_cell_cis_eQTL_mapping/round2.run_spearman_rank_test.R" 

# Do the main job
$R_PATH/Rscript --verbose ${RSCRIPT} ${CELLLABEL} ${SAMPLE} > rout/round2_${CELLLABEL}_${SAMPLE}.Rout
