...
# for 14 cell types using "round5.run_spearman_rank_test.sh" script
##############################################################################
...
# Input filenames
r4_residual_filename <- sprintf("round4/%s_chr%s_eSNP3_adjusted_residuals.tsv", cellLabel, chrNumber)
r4_significant_SNPs <- sprintf("round4/%s_chr%s_round4_significant_correlation_results.tsv", cellLabel, chrNumber)
...
fwrite(eSNP4,sprintf("round4/%s_chr%s_eSNP4.tsv",cellLabel,chrNumber),sep="\t", quote=F)
...
fwrite(adjusted_residual_df,sprintf("round5/%s_chr%s_eSNP4_adjusted_residuals.tsv",cellLabel,chrNumber),sep="\t", quote=F)
...
fwrite(adjusted_spearman_df, sprintf("round5/%s_chr%s_round5_correlation_results.tsv", cellLabel, chrNumber), sep="\t", quote=F)
...
fwrite(adjusted_spearman_df_significant, sprintf("round5/%s_chr%s_round5_significant_correlation_results.tsv", cellLabel, chrNumber), sep="\t",  quote=F)
