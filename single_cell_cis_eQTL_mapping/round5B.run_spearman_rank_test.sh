...
# Title: Conditional cis-eQTL mapping - round 5B
# Author: Seyhan Yazar
# Date: 2020-12-23
# Description: This bash script was written to run an array job 
# per chromosome for 14 cell types using "round5B.run_spearman_rank_test.R" script. 
...
# Main script file
RSCRIPT="/onek1k/single_cell_cis_eQTL_mapping/round5B.run_spearman_rank_test.R"

# Do the main job
$R_PATH/Rscript --verbose ${RSCRIPT} ${CELLLABEL} ${SAMPLE} > rout/round5B_${CELLLABEL}_${SAMPLE}.Rout
